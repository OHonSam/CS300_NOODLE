...
const AdminAnnouncements = () => {
  ...
  const [announcementCreateDialogVisisble, setAnnouncementCreateDialogVisisble] = useState(false);
  ...
  return (
    <div className="relative flex flex-col overflow-y-auto p-8 bg-gray-100 w-full h-full">
      <div className="flex justify-between items-start">
        ...
        <button onClick={() => setAnnouncementCreateDialogVisisble(true)}
      ...
      <div className="relative mt-8 flex flex-col items-center justify-between w-full">
        <Table headings={headings} data={announcements} readOnly={false} rowsPerPage={10} onRowClicked={handleRowClicked}/>
        <AnnouncementDialog 
          dialogFor={'info'}
          announcementData={currentAnnouncementDialog}
          isOpen={announcementDialogVisible}
          onClose={() => setAnnouncementDialogVisible(false)}
        />
        <AnnouncementDialog 
          dialogFor={'create'}
          isOpen={announcementCreateDialogVisisble}
          onClose={() => setAnnouncementCreateDialogVisisble(false)}
        />
        {totalPages > 1 && (
        <Pager 
